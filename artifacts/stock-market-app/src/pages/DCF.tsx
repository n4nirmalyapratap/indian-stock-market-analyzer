    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400">
          Two-stage discounted cash flow with explicit assumptions. Same engine as the bot's <code>/dcf</code> command.
        </p>
      </div>
      ...
      {!symbol && (
        <div className="rounded-lg border border-dashed border-gray-200 dark:border-gray-700 p-12 text-center text-sm text-gray-500">
          Pick a symbol above to compute its intrinsic value.
        </div>
      )}

      {symbol && isLoading && (
        <div className="rounded-lg border border-gray-200 dark:border-gray-700 p-8 text-center text-sm text-gray-500">
